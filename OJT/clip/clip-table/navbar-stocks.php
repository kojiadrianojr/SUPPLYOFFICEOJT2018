...
<nav class="w3-sidenav w3-bu-blue w3-animate-left" style="display:none;z-index:4;">
	...
	<a href="history.php" class="w3-btn w3-text-shadow w3-bu-blue w3-border-white" style="background-color: #001e42; width: 100%; text-align: left;"><h5><i class="fa fa-male"></i> View History </h5></a>
