...
<body>
	<div>
		<div id="office-label">
			...
			<div>
				...
				<input class="search" type="text" name="search_text" id="search_text" placeholder="Search Here">
			</div>
		</div>
	...
	<div style="width:1300px;margin-left:2.5%;">
		<?php
			...
			echo'<a href="print_t2.php?sid='.$sid.'&pin='.$offy_id.'&fid='.$for_id.'" target="_blank" class="w3-btn w3-green" style="float:right;margin-top:-4%;"><i class="fa fa-print"></i>Print</a>';
		?>
		<div id="result">
